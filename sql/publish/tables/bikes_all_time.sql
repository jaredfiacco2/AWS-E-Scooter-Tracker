-- publish.bikes_all_time definition

-- Drop table

-- DROP TABLE publish.bikes_all_time;

--DROP TABLE publish.bikes_all_time;
CREATE TABLE IF NOT EXISTS publish.bikes_all_time
(
...
;
ALTER TABLE publish.bikes_all_time owner to awsuser;